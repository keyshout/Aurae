...
import { RadarScanCard } from "@aurae/components/cards/radar-scan-card";
...
const codeContent = `import { RadarScanCard } from "@keyshout/aurae";
...
export default function RadarScanCardPage() {
  return (
    <div className="flex flex-col gap-16 pb-20">
      <ComponentShowcase
        name="RadarScanCard"
        description="A stunning RadarScanCard component from the cards collection."
        code={codeContent}
